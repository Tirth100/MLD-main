      ...
      <main className="container py-5">
          ...
          <div className="row g-4">
              ...
              <div className="col-lg-7">
                      ...
                      <div className="card-body p-4">
                          ...
                          <div className="d-flex align-items-start mb-3">
                              ...
                              <div>
                                  ...
                                  <p className="text-muted small mb-0">Click the <strong>Download MLD Agent</strong> button below to get the official installer package.</p>
                              </div>
                          </div>
                          ...
                          <div className="d-flex align-items-start mb-3">
                              ...
                              <div>
                                  <h6 className="fw-bold mb-1">Step 2: Extract the ZIP file</h6>
                                  <p className="text-muted small mb-0">Right-click <strong>MLD-Agent.zip</strong> and select <strong>Extract All</strong>.</p>
                              </div>
                          </div>
                          ...
                          <div className="d-flex align-items-start mb-3">
                              ...
                              <div>
                                  <h6 className="fw-bold mb-1">Step 3: Run the Agent</h6>
                                  <p className="text-muted small mb-0">Inside the extracted folder, double-click <strong>run-agent.bat</strong> to start the agent.</p>
                              </div>
                          </div>

                          <div className="d-flex align-items-start mb-3">
                              <div className="badge bg-primary rounded-circle p-3 me-3 fs-6">4</div>
                              <div>
                                  <h6 className="fw-bold mb-1">Step 4: Login to Agent</h6>
                                  <p className="text-muted small mb-0">Enter your <strong>website credentials</strong> (email & password) inside the Agent window.</p>
                              </div>
                          </div>

                          <div className="d-flex align-items-start">
                              <div className="badge bg-success rounded-circle p-3 me-3 fs-6">5</div>
                              <div>
                                  <h6 className="fw-bold mb-1">Step 5: Verify Connection</h6>
                                  <p className="text-muted small mb-0">Click <strong>Verify Connection</strong> to ensure your website badge turns 🟢 <strong>Connected</strong>.</p>
                              </div>
                          </div>
                      </div>
                  </div>
                  ...
                  <div className="card glass-card border-primary border-2 mb-4 text-center py-4 bg-white shadow-sm">
                      <div className="card-body">
                          ...
                          <p className="text-muted mb-4">Compatible with Windows 10/11 & macOS environment</p>
                          
                          <a href="/MLD-Agent.zip" download="MLD-Agent.zip" className="btn btn-primary btn-lg px-5 py-3 shadow fs-5 fw-bold">
              ...
              <div className="col-lg-5">
                  ...
                  <div className="card glass-card border-0 mb-4 shadow-sm">
                      <div className="card-body p-4">
                          <h5 className="fw-bold mb-3"><i className="bi bi-play-circle text-primary me-2"></i>Section 4: After Installation</h5>
                          <ul className="list-group list-group-flush border-0">
                              <li className="list-group-item bg-transparent px-0 py-2 d-flex align-items-center">
                                  <i className="bi bi-check-circle-fill text-success me-2"></i>1. Open MLD Agent on your computer.
                              </li>
                              <li className="list-group-item bg-transparent px-0 py-2 d-flex align-items-center">
                                  <i className="bi bi-check-circle-fill text-success me-2"></i>2. Log in using your website credentials.
                              </li>
                              <li className="list-group-item bg-transparent px-0 py-2 d-flex align-items-center">
                                  <i className="bi bi-check-circle-fill text-success me-2"></i>3. Click <strong>Verify Connection</strong> button below.
                              </li>
                              <li className="list-group-item bg-transparent px-0 py-2 d-flex align-items-center">
                                  <i className="bi bi-check-circle-fill text-success me-2"></i>4. Wait for 🟢 <strong>"Connected"</strong> status badge.
                              </li>
                              <li className="list-group-item bg-transparent px-0 py-2 d-flex align-items-center">
                                  <i className="bi bi-check-circle-fill text-success me-2"></i>5. Join monitoring sessions directly from website!
                              </li>
                          </ul>

                          <div className="mt-4 text-center">
                              <button className="btn btn-outline-primary w-100 py-2" onClick={handleVerify}>
                                  <i className="bi bi-arrow-repeat me-1"></i>Verify Connection Now
                              </button>
                          </div>
                      </div>
                  </div>
